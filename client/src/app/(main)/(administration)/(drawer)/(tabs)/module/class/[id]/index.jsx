        ...
        { text: "Cancel", style: "cancel" },
        {
          ...
          onPress: async () => {
            try {
              ...
              navigation.replace("/(administration)/(drawer)/(tabs)/module/class");
            } catch (error) {
        ...
        <View className="bg-white rounded-xl p-4 mb-4 shadow">
          ...
          <View className="flex-row mt-3">
            <TouchableOpacity
              ...
              onPress={() => 
                navigateTo(`/(administration)/(drawer)/(tabs)/module/class/${id}/edit`)
              }
            >
        ...
        <View className="bg-white rounded-xl p-4 mb-4 shadow">
          <View className="flex-row justify-between items-center mb-3">
            ...
            <TouchableOpacity
              ...
              onPress={() =>
                navigateTo(`/(administration)/(drawer)/(tabs)/module/class/${id}/subjects`)
              }
            >
        ...
        <View className="bg-white rounded-xl p-4 mb-4 shadow">
          <View className="flex-row justify-between items-center mb-3">
            ...
            <TouchableOpacity
              className="flex-row items-center"
              onPress={() =>
                navigateTo(`/(administration)/(drawer)/(tabs)/module/class/${id}/schedule`)
              }
            >
              <Text className="text-secondary-100 font-semibold text-sm">Manage</Text>
              <Ionicons name="chevron-forward" size={16} color="#4C37EE" />
        ...
        <View className="bg-white rounded-xl p-4 mb-4 shadow">
          <View className="flex-row justify-between items-center mb-3">
            ...
            <TouchableOpacity
              className="flex-row items-center"
              onPress={() =>
                navigateTo(`/(administration)/(drawer)/(tabs)/module/class/${id}/teachers`)
              }
            >
              <Text className="text-secondary-100 font-semibold text-sm">Manage</Text>
              <Ionicons name="chevron-forward" size={16} color="#4C37EE" />
        ...
        <View className="bg-white rounded-xl p-4 mb-4 shadow">
          <View className="flex-row justify-between items-center mb-3">
            ...
            <TouchableOpacity
              className="flex-row items-center"
              onPress={() =>
                navigateTo(`/(administration)/(drawer)/(tabs)/module/class/${id}/students`)
              }
            >
