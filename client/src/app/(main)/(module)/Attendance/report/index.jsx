...
const AttendanceReportsScreen = () => {
  ...
  const handleClassSelected = (classId) => {
    if (selectedReportType === "class") {
      router.push({
        pathname: '/(module)/Attendance/report/class-report',
        params: { classId }
      });
    } else if (selectedReportType === "student") {
      router.push({
        pathname: '/(module)/Attendance/report/student-list',
        params: { classId }
      });
    }
  };
      ...
      return (
        <View className="px-4">
          ...
          <ReportTypeCard
            ...
            icon="today"
            color="amber"
            onPress={() => router.push('/(module)/Attendance/report/daily-summary')}
          />
          ...
          <ReportTypeCard
            ...
            icon="stats-chart"
            color="purple"
            onPress={() => router.push('/(module)/Attendance/report/monthly-analysis')}
          />
        </View>
      );
    } else {
