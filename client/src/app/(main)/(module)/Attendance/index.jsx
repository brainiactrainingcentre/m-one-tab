...
const AttendanceMainScreen = () => {
  ...
  const navigateToStudentAttendance = () => {
    router.push('/(module)/Attendance/student-attendance');
  };
  
  const navigateToReports = () => {
    router.push('/(module)/Attendance/report');
  };
  ...
  const navigateToAttendanceCalendar = () => {
    router.push('/(module)/Attendance/calendar');
  };
      ...
      return (
        <View className="px-4">
          ...
          <AttendanceFeatureCard
            ...
            icon="time-outline"
            color="amber"
            onPress={() => router.push('/(module)/Attendance/period-attendance')}
            />
        </View>
      );
